...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">WebCompany</a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href=".?hal=keluar">Logout</a>
                    </div>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="?hal=berita">News</a>
                                    <a class="nav-link" href="?hal=galeri">Galeri</a>
                                    <a class="nav-link" href="?hal=biodata">Biodata</a>
                                </nav>
                            </div>
                            <div class="sb-sidenav-menu-heading">Addons</div>
                            <a class="nav-link" href="?hal=user">
                                <div class="sb-nav-link-icon"></i></div>
                                User
                            </a>
                            <a class="nav-link" href=".?hal=kritiksaran">
